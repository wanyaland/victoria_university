        ...
        <div class="container py-lg-5" style={{paddingBottom: '0rem !important'}}>
            <div class="welcome-grids row">
                <div class="col-lg-12 mb-lg-0 mb-5">
                    ...
                    <p class="my-4" style={{fontSize: '22px'}}>We accept undergraduate applications year-round – if you’re interested in learning the AU way, you can start right away. Enrol in a program to earn a degree, diploma or certificate, or just take some courses as a non-program student - it’s up to you. If you change your mind later, you won’t have to pay another application fee. You can start registering for courses as soon as you finish your application.</p>
					...
					<div class="" style={{width: '100%', backgroundColor: '#fff', border: '#CCC 10px solid'}}>
						<ul class="w3-ul w3-card-4" style={{boxShadow: 'none'}}>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
                                        ...
                                        <p class="my-4">You are now ready to become an AU student and receive an AU student ID number, and apply to an undergraduate program.</p>
                                        ...
                                        <p class="my-4">&emsp;<span>3.</span> &nbsp;ApplyAlberta will return you to the AU site. Complete the rest of the application.</p>
                                        <p class="my-4">&emsp;<span>4.</span> &nbsp;Pay the one-time general application fee  and the evaluation fee (if applicable). Be sure to have your official transcripts sent to AU if ApplyAlberta was unable to forward them automatically.</p>
                                        <p class="my-4">&emsp;<span>5.</span> &nbsp;Write down your AU student ID number at the end of the application process. Your ID number will also appear on your printed or e-mailed receipt if you choose one of those options.</p>
                                        ...
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
                                            <h4 class="lohny-2"><span  id="iconner" class="fa fa-chain programfa" style={{backgroundColor: '#ff7b00'}}></span><span id="iconner2" class="fa fa-arrow-right programfa hider" style={{backgroundColor: '#ff7b00', color: '#FFF', fontSize: '26px'}}></span>&nbsp;Apply Now</h4>
                                            </a>
                                        </p>
									</div>
								</div>	
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
										<p class="my-4">Whether you need a course to transfer to a program elsewhere, for professional development, or just for fun, you can do it as a non-program student at Athabasca University.</p>
                                        <p class="my-4">Non-program (or unclassified) students are those who want to take courses without registering in a degree, diploma or certificate program. If you later decide to enter an AU program, you can apply credits earned now toward your future program (if the credits fit that program’s requirements).</p>
                                        ...
                                        <p class="my-4">&emsp;<span>3.</span> &nbsp;Write down your AU student ID number at the end of the application process. Your ID number will also appear on your printed or e-mailed receipt if you choose one of those options.</p>
                                        <p class="my-4">&emsp;<span>4.</span> &nbsp;You are now ready to start registering for AU Undergraduate Course as a Non-Program Student</p>
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solids'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor:'#fff'}}>
                                        ...
                                        <p class="my-4">Keep in mind that you can't start a full AU degree until you've completed or withdrawn from your other program.</p>
                                        ...
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
                                            <h4 class="lohny-2"><span  id="iconner" class="fa fa-chain programfa" style={{backgroundColor: '#ff7b00'}}></span><span id="iconner2" class="fa fa-arrow-right programfa hider" style={{backgroundColor: '#ff7b0', color: '#FFF', fontSize: '26px'}}></span>&nbsp;Apply Now</h4>
                                            </a>
                                        </p>
									</div>
								</div>	
					...
					<div class="" style={{width: '100%', backgroundColor: '#fff', border:'#CCC 10px solid'}}>
						<ul class="w3-ul w3-card-4" style={{boxShadow: 'none'}}>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
										<p class="my-4">If you are enrolled in an AU program, you should review your program requirements (program regulations) before registering for courses.</p>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
										<p class="my-4">If your application to Athabasca University was successful, you can start registering for courses immediately - just like everyone else.</p>
									</div>
								</div>	
								<br/>
							  </div>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
                                        ...
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
                                            <h4 class="lohny-2"><span  id="iconner" class="fa fa-chain programfa" style={{backgroundColor: '#ff7b00'}}></span><span id="iconner2" class="fa fa-arrow-right programfa hider" style={{backgroundColor: '#ff7b00', color: '#FFF', fontSize: '26px'}}></span>&nbsp;Check the course availability</h4>
                                            </a>
                                        </p>
									</div>
								</div>	
                              ...
                              <div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
                                  ...
                                  <div class="col-lg-12 welcome-image">
                                      <div class="" style={{width: '100%', backgroundColor: '#fff'}}>
                                        ...
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
                                            <h4 class="lohny-2"><span  id="iconner" class="fa fa-chain programfa" style={{backgroundColor: '#ff7b00'}}></span><span id="iconner2" class="fa fa-arrow-right programfa hider" style={{backgroundColor: '#ff7b00', color: '#FFF' ,fontSize: '26px'}}></span>&nbsp;Start Now</h4>
                                            </a>
                                        </p>
                                        <h6 class="hny-title" style={{color: '#043a57'}}>After you register</h6>
                                        <p class="my-4">You will receive an e-letter in myAU with your tutor or support information 1–2 weeks before your course starts. In most cases, you will also be able to access your courses from myAU before the official course start date.</p>
                                      </div>
                                  </div>	
                                  <br/>
                                </div>
					...
					<div class="" style={{width: '100%', backgroundColor: '#fff', border:'#CCC 10px solid'}}>
						<ul class="w3-ul w3-card-4" style={{boxShadow: 'none'}}>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
										<p class="my-4">Athabasca University’s graduate student application processes vary from program to program. Read the general application process below, then find your program to see its specific requirements and processes.</p>
                                        ...
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
                                            <h4 class="lohny-2"><span  id="iconner" class="fa fa-chain programfa" style={{backgroundColor: '#ff7b00'}}></span><span id="iconner2" class="fa fa-arrow-right programfa hider" style={{backgroundColor: '#ff7b00', color: '#FFF', fontCize: '26px',}}></span>&nbsp;See all graduate programs</h4>
                                            </a>
                                        </p>
                                        ...
                                        <p class="my-4">&emsp;<span>3.</span> &nbsp;If you have ever been an AU student in the past, log in to complete the application.</p>
                                        <p class="my-4">&emsp;<span>4.</span> &nbsp;If you are a new AU student, be sure to write down your student ID number at the end of the application process. Your ID number will also appear on your printed or e-mailed receipt if you choose one of those options.</p>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
										<p class="my-4">In order to take graduate-level courses, you must satisfy certain prerequisites, which in most cases include an undergraduate degree. However, you don’t need to be enrolled in an Athabasca University graduate program to take our graduate courses.</p>
							...
							<div class="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div class="col-lg-12 welcome-image">
									<div class="" style={{width: '100%', backgroundColor: '#fff'}}>
                                        ...
                                        <p class="my-4">If you’re enrolled at another university and want to take an AU course for one of your program requirements, you also register as a non-program student. We encourage you to get a letter of permission from your school to ensure your AU credits will transfer to your program. This is for your own records – you don’t have to send it to AU.</p>
                                        <p><a class="logo-2" href="home" style={{color: '#0077b5'}}  onmouseover="change_icon(this)" onmouseout="change_icon2(this)">
                                            <h4 class="lohny-2"><span  id="iconner" class="fa fa-chain programfa" style={{backgroundColor: '#ff7b00'}}></span><span id="iconner2" class="fa fa-arrow-right programfa hider" style={{backgroundColor: '#ff7b00', color: '#FFF', fontSize: '26px'}}></span>&nbsp;Apply Now</h4>
                                            </a>
                                        </p>
