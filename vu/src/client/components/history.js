        ...
        <div class="container py-lg-5" style={{paddingBottom: '0rem !important'}}>
            <div class="welcome-grids row">
                <div class="col-lg-12 mb-lg-0 mb-5">
                    ...
                    <p class="my-4" style={{fontSize: '22px'}}>By 1984, VU had outgrown its original facilities in Edmonton and, in accordance with the policy of decentralization favoured by the provincial government of the day, the university moved 145 kilometres north to the Town of Victoria. Satellite campuses were established in Calgary, Edmonton and Fort McMurray, Alberta, to enable students to receive first-hand educational support services and to write invigilated examinations. The Fort McMurray location closed in 2000.</p>
                    <p class="my-4" style={{fontSize: '22px'}}>During the 1980s, in keeping with its mandate to explore new ways of delivering post-secondary education to students anywhere, any time, VU pioneered the use of computers to deliver online courses. AU's Executive MBA program, the world's first online EMBA, was introduced by AU's Centre for Innovative Management in 1994.</p>
                    <p class="my-4" style={{fontSize: '22px'}}>Today, VU is one of the world's foremost and fastest growing online and distance education institutions, serving over 40,000 students worldwide.
                    </p>
                </div>
            </div>
        </div>
