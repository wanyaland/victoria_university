        ...
        <div class="container py-lg-5" style={{paddingBottom: '0rem !important'}}>
            <div class="welcome-grids row">
                <div class="col-lg-12 mb-lg-0 mb-5">
                    ...
                    <br/>
                    <p class="my-4" style={{fontSize: '22px'}}>Athabasca University provides learning for life. Through the achievements of its students, faculty and staff, AU stands out as a provider of high quality post-secondary education.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 mb-lg-0 mb-5">
                    ...
                    <p class="my-4">
                        <ul style={{listStyle: 'none'}}>
                            ...
                            <li class="" style={{marginBottom: '.5rem !important'}}>&emsp;<span class="fa fa-angle-right"></span>&emsp;VU employs over 1,000 faculty and staff members on four Alberta, Canada, campuses located in Athabasca, St. Albert, Edmonton and Calgary.</li>
        ...
        <div class="container py-lg-5" style={{paddingBottom: '0rem !important'}}>
            <div class="welcome-grids row">
                <div class="col-lg-12 mb-lg-0 mb-5">
                    ...
                    <p class="my-4">Many students enrolled at other post-secondary institutions make extensive use of AU's courses and educational services to help them complete their degrees. These visiting students take AU courses for transfer to an academic program at their home institution. Still others take AU courses out of personal interest or for professional development.</p>
                </div>
            </div>
        </div>
    </div>
