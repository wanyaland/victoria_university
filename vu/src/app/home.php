		...
		<div class="container py-lg-5">
			...
			<div class="row title-content">
				<div class="col-lg-4 title-left">
					<h3 class="hny-title">Welcome To Our Campus</h3>
				</div>
			...
			<section class="w3l-footer-16 text-center">
				<div class="">
					...
					<h3 class="hny-title text-center">Select Your Path</h3>
			...
			<div class="columns-2 mt-md-0 mt-3">
                    <ul class="social justify-content-center d-flex">
                        <li><a href="#"></a></li><hr style="border:#555 1px solid; width:25%">
                        <li><a href="#"></a></li><hr style="border:#555 1px solid; width:25%">
						<li><a href="#"></a></li><hr style="border:#555 1px solid; width:25%">
                        <li><a href="#"></a></li>
                    </ul>
			...
			<div class="content-info-in row mt-md-5 mt-4">
				...
				<div class="col-lg-3 col-md-6 imghrs">
					<a class="imghr" href="#"><img src="assets/images/path1.jpg" class="img-fluid" alt="">
						<div class="details"><span class="title">Foundation</span><span class="info">Add Description</span></div>
					</a>
				</div>
				<div class="col-lg-3 col-md-6 imghrs">
					<a class="imghr" href="#"><img src="assets/images/path3.jpg" class="img-fluid" alt="">
						<div class="details"><span class="title">Undergradate</span><span class="info">Add Description</span></div>
					</a>
				</div>
				<div class="col-lg-3 col-md-6 imghrs">
					<a class="imghr" href="#"><img src="assets/images/path2.jpg" class="img-fluid" alt="">
						<div class="details"><span class="title">Postgraduate</span><span class="info">Add Description</span></div>
					</a>
				</div>
				<div class="col-lg-3 col-md-6 imghrs">
					<a class="imghr" href="#"><img src="assets/images/path4.jpg" class="img-fluid" alt="">
						<div class="details"><span class="title">Diploma</span><span class="info">Add Description</span></div>
					</a>
				</div>
			</div>
...
<section class="w3l-features-1">
	...
	<div class="features-1-mian py-5">
		<div class="">
					<h3 class="hny-title text-center">Maximize</h3>
		...
		<div class="container py-lg-5">
			...
			<div class="row title-content">
				<!--<div class="col-lg-4 title-left">
					<h3 class="hny-title text-center">What do you want to Learn today?</h3>
				</div>-->
				<!--<div class="col-lg-8 title-info">
			...
			<div class="counter-main-sec">
				<div class="">
					<h3 class="hny-title text-center">HOW VU WORKS</h3>
				...
				<div class="counter-grids-info">
					<div class="counter-gd">
						<h4>More than</h4>
						<h6>95%</h6>
						<p>of our grads are satisfied with their VU education<p>
					</div>
					<div class="counter-gd">
						<h4>More than</h4>
						<h6>95%</h6>
					...
					<div class="counter-gd">
						<h4>Nearly</h4>
						<h6>90%</h6>
						<p>of our grads are in a job related to their field study</p>
					</div>
					<div class="counter-gd">
						<h4>Nearly</h4>
						<h6>98%</h6>
						<p>of grads agree to the student to faculty ratio</p>
					</div>
				</div>
				<br><br>
				<div class="text-center">
					<a class="logo-2" href="home.php" style="">
                                        <h3 class="lohny-2 text-center"><span class="fa fa-chain"></span>&nbsp;What Makes VU Unique</h3></a>
...
<section class="w3l-apply-6">
	...
	<div class="apply-info py-5">
		<div class="container py-lg-5 text-center" style="font-weight: 100;">
						<h3 class="hny-title text-center" style="color: #fff">Come Prepared To Learn, Leave Prepared To Succeed</h3>
		</div>
	</div>
</section>
			...
			<div class="row">
				...
				<div class="col-md-3 filter graphic photo">
					...
					<div class="course-content">
						<div class="course-info">
							<a href="#" class="course-title-wrapper">
								<h3 class="course-title" data-gal="prettyPhoto[gallery]">Baby Gloria - Brand Ambassador</h3>
							</a>
							<h6><a class="course-instructor" href="#">On 1st March, 2021, Victoria University, Kampala unveiled a new brand ambassador; Baby Gloria.</a></h6>
						</div>
						<div class="course-divider">
							<div class="course-meta"><span class="course-students" title=""><span
										class="fa fa-clock-o" aria-hidden="true"></span> 46 Mins Ago</span>
			...
			<div class="row">
				...
				<div class="col-md-3 filter webdesign graphic">
					...
					<div class="course-content">
						<div class="course-info">
							<a href="#" class="course-title-wrapper">
								<h3 class="course-title" data-gal="prettyPhoto[gallery]">End of Year Party/Handover</h3>
							</a>
						</div>
						<div class="course-divider">
							<div class="course-meta grid"><span class="course-students" title=""><span
										class="fa fa-clock-o" aria-hidden="true"></span> Dec 1</span>
								<span class="course-reviews" title=""><span class="fa fa-map-marker"
										aria-hidden="true"></span> Main Campus</span>
