          ...
          <div className="apply-info py-5">
            <div className="container py-lg-5">
              ...
              <p className="text-center">
                <button className="btn_link" onClick={this.startHere}>
                  Jobs
                </button>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button className="btn_link">Student Recruitment</button>
              </p>
              <br />
              <br />
              <br />
                          ...
                          >
                            ...
                            >
                              ...
                              <li className="job_title">
                                <a
                                  href="assets/docs/job_ad2.pdf"
                                  download="assets/docs/job_ad2.pdf"
                                  title="job_ad2.pdf"
                                >
                                  Job Description&nbsp;
                                  <span
                        ...
                        <div className="col-lg-12 welcome-image">
                          ...
                          >
                            ...
                            >
                              ...
                              <li className="job_title">
                                <a
                                  href="assets/docs/2022 FACILITY SUPERVISOR.pdf"
                                  download="assets/docs/2022 FACILITY SUPERVISOR.pdf"
                                  title="2022 FACILITY SUPERVISOR.pdf"
                                >
                                  Job Description&nbsp;
                                  <span
                                    className="fa fa-file-pdf-o"
          ...
          >
            <div className="">
              <h4
                ...
                style={{ color: "#0077b5", fontSize: "36px" }}
              >
                ...
                <div className="features-1-info col-lg-4 col-md-6">
                  ...
                  <div className="features-1-info-info text-center">
                    <h6 className="text-center">
                      Commission for student recruitment
                    </h6>
                    <p>
                      Commission for every successful student recruitment made
                    </p>
                  </div>
                </div>
                <div className="features-1-info col-lg-4 col-md-6">
                  ...
                  <div className="features-1-info-info text-center">
                    ...
                    <p>
                      Coverage for dental, vision, prescription drugs,
                      out-of-country health care coverage, counselling services.
                    </p>
                  </div>
                </div>
                <div className="features-1-info col-lg-4 col-md-6">
              ...
              <div className="row grids-innf my-lg-5">
                <div className="features-1-info col-lg-4 col-md-6">
                  ...
                  <div className="features-1-info-info text-center">
                    ...
                    <p>
                      Holiday break from Dec 25 – Jan 1 each year, sick leave,
                      special leave, parental leaves (maternity,
                      parental/adoption), compassionate care leave.
                    </p>
                  </div>
                </div>
                <div className="features-1-info col-lg-4 col-md-6">
                  ...
                  <div className="features-1-info-info text-center">
                    ...
                    <p>
                      Paid time off and funds each year for professional
                ...
                <div className="features-1-info col-lg-4 col-md-6">
                  ...
                  <div className="features-1-info-info text-center">
                    ...
                    <p>
                      Paid research and study leave for academic, professional
                      and tutor positions.
                    </p>
                  </div>
                </div>
