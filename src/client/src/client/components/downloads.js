              ...
              <div className="row">
                <div className="col-md-12 filter graphic">
                  <div className="each-item">
                    <p>
                      Here all the necessary downloads, publications and all
                      relevant documents you may be interested in. <br /> Click
                      to download:
                    </p>
                  </div>
                </div>
                ...
                <div className="col-md-12 filter graphic photo">
                  <div className="each-item">
                    ...
                    <li className="underline lister">
                      ...
                      >
                        Download Full Profile of Vice Chancellor{" "}
                        <span
                          className="fa fa-file-pdf-o"
                          style={{ color: "#f74040" }}
                        ></span>{" "}
                    ...
                    <li className="underline lister">
                      <a
                        ...
                        className="underline"
                        download={"assets/docs/students charter.pdf"}
                      >
                        Students' charter
                        <span
                          className="fa fa-file-pdf-o"
