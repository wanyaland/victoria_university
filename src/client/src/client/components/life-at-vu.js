              ...
              <div className="welcome-grids row">
                <div className="col-lg-12 mb-lg-0 mb-5">
                  ...
                  <p className="my-4" style={{}}>
                    With111 a truly national and increasingly international
                    ...
                    on-campus activities. Our students have a variety of
                    co-curricular activities they can engage in including
                  ...
                  <div className="mission-gd-right col-lg-12 pl-lg-4">
                    ...
                    />
                    <p>
                      <b style={{ fontWeight: "500" }}>Image:</b> Basketball
                      Team
                    </p>
                  </div>
                  <p className="my-4">
                    Students also organise several social activities including;
                  </p>
                  <p className="my-4">
                    <ul style={{ listStyle: "none" }}>
                      <li className="mb-4 t2">
                        ...
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">Mr. and Miss VU</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">Vice Chancellor’s Dinner</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">International Day</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">End of Year party</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">End of Semester Party</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">Freshers’ Ball</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">Fun Day</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">Movie Night</span>
                      </li>
                      <li className="mb-4 t2">
                        &emsp;
                        <span
                          ...
                          style={{ color: "#025683" }}
                        ></span>
                        &emsp;<span className="">Faculty Deans’ Outing"</span>
                      </li>
                    </ul>
                  </p>
                  <div className="mission-gd-right col-lg-12 pl-lg-4">
                    <img
                      src="assets/images/intstud.jpg"
                      className="img-fluid"
                      alt="WIL"
                    />
                    <p>
                      <b style={{ fontWeight: "500" }}>Image:</b> International
                      Day
                    </p>
                  </div>
                </div>
