        ...
        <div className="container py-lg-5" style={{paddingBottom: '0rem !important'}}>
            <div className="welcome-grids row">
                <div className="col-lg-12 mb-lg-0 mb-5">
                    <h6 className="hny-title" style={{fontSize: '48px', color: 'orange', fontWeight: '600'}}>Library</h6>
                    <br/>
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>About the Library</p>
                    ...
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>VULIB as an outstanding library</p>
                    ...
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>Enabling world-class research</p>
                    ...
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>Flexible learning spaces</p>
                    ...
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>A supportive Library staff environment</p>
                    ...
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>Our mission, our vision and how we support the University</p>
                    ...
                    <p className="my-4">
                        <p className="my-4" style={{fontSize: '22px', fontWeight: '500'}}>Health and safety measures during Covid 19</p>
