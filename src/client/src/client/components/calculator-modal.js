                ...
                <div className="features-1-info col-lg-12 col-md-12" style={{height: '50px', width: '100%', padding: '0', marginBottom: '40px'}}>
                  ...
                  <div className="container_form">
                    ...
                    <p id="reseter" style={{padding: '5px'}}>
                      <span href="tune" className="cal-btn" onClick={this.reseter}>Start Over</span>&nbsp;
                    </p>
                            ...
                            <table style={{width: '100%', height: '100%'}}>
                              ...
                              <tr>
                                <td className="text-left" style={{backgroundColor: '#FFF', textAlign: 'center', color: '#444', padding: '10px', width: '100%', border: '#777 1px solid'}}>
                                  <input type="radio" id="local" name="fav_language" value="Ugandan" onChange={this.view_stud.bind(this, "local")}/><span for="Local"> Yes</span><br/>
                                  <input type="radio" id="int" name="fav_language" value="International" onChange={this.view_stud.bind(this, "int")}/><span for="International"> No</span>
                                </td>
                              </tr>
