                ...
                <div className="col-lg-3 side_control" id="mob_bar_control">
                    <div className="sidenavd">
                        ...
                        <div style={{width: '35%', border:'#f04545 2px solid'}} className="text-ec"></div></li>
                            ...
                            <li className="w3-display-container" style={{borderBottom: 'none', padding: '6px 22px'}}><Link to='/benefits' style={{fontSize: '16px'}}>Benefits<span onClick="this.parentElement.style.display='none'" className="w3-button w3-transparent w3-display-right"></span></Link></li>
                            <li className="w3-display-container"style={{borderBottom: 'none', padding: '6px 22px'}}><Link to='/costs-and-insurance' style={{fontSize: '16px'}}>Costs and insurance<span onClick="this.parentElement.style.display='none'" className="w3-button w3-transparent w3-display-right"></span></Link></li>
                            <li className="w3-display-container"style={{borderBottom: 'none', padding: '6px 22px'}}><Link to='/wil-hall-of-fame' style={{fontSize: '16px'}}>WIL Hall of Fame<span onClick="this.parentElement.style.display='none'" className="w3-button w3-transparent w3-display-right"></span></Link></li>
