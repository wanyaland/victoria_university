			...
			<div className="justify-content-center"  style={{display: 'flex'}}>
				...
				<div className="col-lg-9"   style={{padding: '25px', backgroundColor: '#FFF', borderTopLeftRadius: '15px'}}>
                    ...
                    <h6 className="hny-title" style={{fontSize: '48px',  color: '#f74040', fontWeight: '600'}}>Faqs</h6>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>1. How to access e-books and e-journals on and off the campus network?</p>
                        <p className="mb-4">
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>2. How can I register for a university email?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>3. How to connect to Library’s Wifi?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>4. How can I find a book on a certain topic?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>5. I would like to know more about the library account for students. I have often seen this Log in box whenever I open the Library catalog. How I can log in such account.</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>6. What do i do to renew a book?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>7. I have noticed there are some books that come with DVDs that contain the entire notes on the same book. Can students ever get access to these DVDs?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>8. What’s the process & requirement for registering with the library in order to start using the library ser-vices?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>9. How can CISCO students access the library as they are normally not issued with School ID cards which are needed so as to access the library?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>10. How many hours or minutes should people take in the computer room?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>11. How can I access the Discussion rooms in the Library?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>12. How can I get a job in the library?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
                        ...
                        <p className="my-4" style={{fontSize: '22px'}}>13. Is it possible to get an attachment in the library?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
