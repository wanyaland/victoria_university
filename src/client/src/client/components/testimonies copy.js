	...
	<div class="specification-content py-5">
		<div class="container py-lg-5" style={{maxWidth: '100%', display: 'flex'}}>
			<div class="mission-grids-info row">
				...
				<div class="mission-gd-right col-lg-6 pl-lg-4 testimonial_text"  style={{overflow: 'hidden'}}>
					<div class="w3-content w3-section">
						<div class="testimonial_slides item-1">
							<p style={{color: '#FFF'}}>
						...
						<div class="testimonial_slides item-2">
							<p style={{color: '#FFF'}}>
								<span class="fa fa-quote-left" style={{fontSize: '40px'}}></span>
								<br/>
								...
								<div class="course-content">
									<div class="course-divider">
										<div class="course-meta" style={{color: '#FFF'}}>
											...
											<span class="overview" style={{color: '#FFF'}}>Bachelor Of Business</span>
										</div>
									</div>
								</div>
							</p>
						</div>
						<div class="testimonial_slides item-3">
							<p style={{color: '#FFF'}}>
								<span class="fa fa-quote-left" style={{fontSize: '40px'}}></span>
								<br/>
