                      ...
                      <div className="col-md-3 filter webdesign graphic">
                        <div className="each-item">
                          <Link to="/directors">
                            <img
                              ...
                              src="assets/images/trustees/aliker.jpg"
                              alt=""
                        ...
                        <div className="course-content">
                          ...
                          <div className="course-divider">
                            ...
                            <Link to="/directors" className="price-course btn">
                              View
                            </Link>
                          </div>
                        </div>
                      ...
                      <div className="col-md-3 filter webdesign graphic">
                        ...
                        <div className="course-content">
                          ...
                          <div className="course-divider">
                            ...
                            <Link to="/council" className="price-course btn">
                              View
                            </Link>
                          </div>
                        </div>
                      ...
                      <div className="col-md-3 filter webdesign graphic">
                        ...
                        <div className="course-content">
                          ...
                          <div className="course-divider">
                            ...
                            <Link to="/senate" className="price-course btn">
                              View
                            </Link>
                          </div>
                        </div>
                      ...
                      <div className="col-md-3 filter webdesign graphic">
                        ...
                        <div className="course-content">
                          ...
                          <div className="course-divider">
                            ...
                            <Link to="/staff" className="price-course btn">
                              View
                            </Link>
                          </div>
                        </div>
