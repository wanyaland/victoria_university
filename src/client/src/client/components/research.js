			...
			<div className="justify-content-center"  style={{display: 'flex'}}>
				...
				<div className="col-lg-9"   style={{padding: '25px', backgroundColor: '#FFF', borderTopLeftRadius: '15px'}}>
                    <div className="col-lg-12 mb-lg-0 mb-5">
						...
						<br/>
						<p className="my-4" style={{fontSize: '22px'}}>Victoria University is a Comprehensive Research University (CARU) committed to the highest professional standards of scholarly research and research ethics. VU's research includes a wide range of creative and innovative scholarly activity.</p>
