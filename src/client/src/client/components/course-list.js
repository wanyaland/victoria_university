        ...
        >
          ...
          >
            <div className="each-item">
              <Link to={`/view-program/${item.program}`}>
                <img
            ...
            <div className="course-content" style={{ minHeight: "6.5rem" }}>
              <div className="course-info">
                <Link
                  to={`/view-program/${item.program}`}
                  className="course-title-wrapper"
                >
                  <h3 className="course-title" data-gal="prettyPhoto[gallery]">
                    {item.program}
                  </h3>
                </Link>
              </div>
              {/* <div className="course-divider">
                <div className="course-meta grid">
                  <span className="course-students" title="">
                    UGX {item.local_price} <b>OR</b> USD {item.int_price}
                  </span>
