...
class ProgIndex extends Component {
  ...
  getCourses = () => {
    if (this.props.match.params.program === "undergraduate") {
      ...
      this.props.match.params.program === "faculty_Techundergraduate"
    ) {
      ...
      this.props.match.params.program === "faculty_HealthPostgraduate"
    ) {
      this.getFacHealthPost();
    } else if (
      this.props.match.params.program === "faculty_Healthundergraduate"
    ) {
      this.getFacHealthUnder();
    } else if (
      this.props.match.params.program === "faculty_Healthprofessional"
    ) {
      this.getFacHealthPros();
    } else if (this.props.match.params.program === "faculty_HealthFound") {
      this.getFacHealthFound();
    } else if (
      this.props.match.params.program === "faculty_HumanPostgraduate"
    ) {
      this.getFacHumanPost();
    } else if (
      this.props.match.params.program === "faculty_Humanundergraduate"
    ) {
  ...
  getFacBusPostgs = () => {
    var result = Data.filter(
      (course) =>
        ...
        course.faculty === "Faculty Of Business And Management"
    );
    this.setState({
      courses: result,
  ...
  getFacBusPros = () => {
    ...
    this.setState({
      courses: result,
      courses_title:
        "Faculty Of Business And Management (Professional Development)",
    });
  };
  ///////
  getFacTechPost = () => {
    var result = Data.filter(
      (course) =>
        course.level === "Postgraduate" &&
        course.faculty === "Faculty Of Science And Technology"
    );
    this.setState({
      courses: result,
  ...
  getFacTechPros = () => {
    ...
    this.setState({
      courses: result,
      courses_title:
        "Faculty of Science and Technology (Professional Development)",
    });
  };
  /////
  getFacHealthPost = () => {
    var result = Data.filter(
      (course) =>
        course.level === "Postgraduate" &&
        course.faculty === "Faculty of Health Sciences"
    );
    this.setState({
      courses: result,
  ...
  getFacHealthFound = () => {
    ...
    this.setState({
      courses: result,
      courses_title:
        "Faculty of Health Sciences (Higher Educational Certificate)",
    });
  };
  //////
  getFacHumanPost = () => {
    var result = Data.filter(
      (course) =>
        course.level === "Postgraduate" &&
        course.faculty === "Faculty of Humanities and Social Sciences"
    );
    this.setState({
      courses: result,
  ...
  getFacHumanFound = () => {
    ...
    this.setState({
      courses: result,
      courses_title:
        "Faculty of Humanities and Social Science (Higher Educational Certificate)",
    });
  };
  getFacHumanPros = () => {
    var result = Data.filter(
    ...
    this.setState({
      courses: result,
      courses_title:
        "Faculty of Humanities and Social Science (Professional Development)",
    });
  };
  /////////
  getFacEduPost = () => {
    var result = Data.filter(
      (course) =>
        course.level === "Postgraduate" &&
        course.faculty === "Faculty of Education"
    );
    this.setState({
      courses: result,
  ...
  getFacLawPost = () => {
    var result = Data.filter(
      (course) =>
        course.level === "Postgraduate" && course.faculty === "School Of Law"
    );
    this.setState({
      courses: result,
  ...
  getFacLawUnder = () => {
    var result = Data.filter(
      (course) =>
        course.level === "Undergraduate" && course.faculty === "School Of Law"
    );
    this.setState({
      courses: result,
  ...
  getPostGs = () => {
    ...
    this.setState({
      ...
      courses_desc:
        "Victoria University offers post  graduate programmes, listed below under their respective faculties",
    });
  };
  getUnder = () => {
    ...
    this.setState({
      ...
      courses_desc:
        "Victoria  University offers a number of Bachelors Degree Programmes. They are listed below under their respective faculties.",
    });
  };
  getPros = () => {
    var result = Data.filter(
      (course) => course.level === "Professional Development"
    );
    this.setState({
      courses: result,
      courses_title: "Professional Development Programmes",
      courses_desc:
        "Join one of our professional development courses and learn new and verifiable skills for your career.",
    });
  };
  getFounds = () => {
    ...
    this.setState({
      ...
      courses_desc:
        "Victoria University offers foundation programs that help prepare students for higher education and also advance their careers. The Higher Educational Certificate (HEC) helps students who did not attain the minimum requirement of 2 principal passes to pursue an undergraduate program at university. ",
    });
  };
  getDiploma = () => {
    ...
    this.setState({
      ...
      courses_desc:
        "Victoria University offers the following Diploma programs in the Faculties of Business Management, Science and Technology, Health Sciences, Humanities and Social Sciences.",
    });
  };
  no_result = () => {
    this.setState({
  ...
  postCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].level === "Postgraduate") count++;
    }
    this.setState({
      post_sum: count,
    });
  ...
  underCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].level === "Undergraduate") count++;
    }
    this.setState({
      under_sum: count,
    });
  ...
  diplomaCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].level === "Diploma") count++;
    }
    this.setState({
      diploma_sum: count,
    });
  ...
  foundCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].level === "Foundations") count++;
    }
    this.setState({
      found_sum: count,
    });
  ...
  proCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].level === "Professional Development") count++;
    }
    this.setState({
      pro_sum: count,
    });
  ...
  getBusiness = () => {
    var result = Data.filter(
      (course) => course.faculty === "Faculty Of Business And Management"
    );
    this.setState({
      courses: result,
  ...
  getTech = () => {
    var result = Data.filter(
      (course) => course.faculty === "Faculty Of Science And Technology"
    );
    this.setState({
      courses: result,
  ...
  getHealth = () => {
    var result = Data.filter(
      (course) => course.faculty === "Faculty of Health Sciences"
    );
    this.setState({
      courses: result,
  ...
  getHumanities = () => {
    var result = Data.filter(
      (course) => course.faculty === "Faculty of Humanities and Social Sciences"
    );
    this.setState({
      courses: result,
  ...
  getEdu = () => {
    var result = Data.filter(
      (course) => course.faculty === "Faculty of Education"
    );
    this.setState({
      courses: result,
  ...
  busyCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].faculty === "Faculty Of Business And Management") count++;
    }
    this.setState({
      busy_count: count,
    });
  ...
  techCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].faculty === "Faculty Of Science And Technology") count++;
    }
    this.setState({
      tech_count: count,
    });
  ...
  healthCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].faculty === "Faculty of Health Sciences") count++;
    }
    this.setState({
      health_count: count,
    });
  ...
  eduCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].faculty === "Faculty of Education") count++;
    }
    this.setState({
      edu_count: count,
    });
  ...
  lawCount = () => {
    ...
    var count = 0;
    for (var i = 0; i < progData.length; ++i) {
      if (progData[i].faculty === "School Of Law") count++;
    }
    this.setState({
      law_count: count,
    });
          ...
          <div className="team">
            <div className="container py-lg-5" style={{ maxWidth: "100%" }}>
              <div
                ...
                style={{ display: "flex" }}
              >
                <button className="side_control_btn" onClick={this.showSide}>
                  <span
                    className="fa fa-bars text-center justify-content-center"
                    style={{ fontSize: "30px" }}
                  ></span>
                </button>
                <div
                  className="col-lg-3 with_shadow side_control"
                  id="mob_bar_control"
                  style={{ padding: "0px" }}
                >
                  <div className="sidenavd" style={{ paddingTop: "0px" }}>
                    ...
                    <div style={{ paddingLeft: "10px", paddingRight: "10px" }}>
                      <p
                        className="my-2 text-right refresh"
                        style={{ fontSize: "18px", fontWeight: "400" }}
                        onClick={this.getAllCourses}
                      >
                        <span className="fa fa-refresh"></span> Reset
                      </p>
                    </div>
                    <hr />
                    <div>
                      ...
                      >
                        <li
                          className={
                            this.state.courses_title === "All Programmes"
                              ? "prog-list prog-list-active"
                              : "prog-list"
                          }
                          onClick={this.getAll}
                          style={{
                        ...
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "100%" }}>
                                <span style={{ width: "90%" }}>
                                  <span className="fa fa-graduation-cap grad_icon orange_color"></span>
                                  &nbsp;&nbsp;&nbsp;All Programmes
                                </span>
                              </td>
                              <td>
                                <span className="badged">
                                  {this.state.courses_count}
                                </span>
                              </td>
                            </tr>
                          </table>
                        ...
                        <li
                          className={
                            this.state.courses_title ===
                            "Postgraduate Programmes"
                              ? "prog-list prog-list-active"
                              : "prog-list"
                          }
                          onClick={this.getPostGs}
                          style={{
                            width: "100%",
                            borderBottom: "#CCC 1px solid",
                          }}
                        ...
                        <li
                          ...
                          onClick={this.getUnder}
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "100%" }}>
                                <span style={{ width: "90%" }}>
                                  <span className="fa fa-graduation-cap grad_icon"></span>
                                  &nbsp;&nbsp;&nbsp;Undergraduate Programs
                                </span>
                              </td>
                              <td>
                                <span className="badged">
                                  {this.state.under_sum}
                                </span>
                              </td>
                            </tr>
                          </table>
                        ...
                        <li
                          className={
                            this.state.courses_title === "Diploma Programmes"
                              ? "prog-list prog-list-active"
                              : "prog-list"
                          }
                          style={{
                        ...
                        <li
                          className={
                            this.state.courses_title === "Foundations"
                              ? "prog-list prog-list-active"
                              : "prog-list"
                          }
                          style={{
                    ...
                    <ul className="" style={{ padding: "10px" }}>
                      ...
                      <Link onClick={this.getCourses}>
                        <li
                          className="prog-list-course-outline"
                          style={{ width: "100%" }}
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td>
                                <span className="fa fa-circle purple_color"></span>
                              </td>
                              <td style={{ width: "90%" }}>
                                <span style={{ width: "80%" }}>All</span>
                              </td>
                            </tr>
                          </table>
                        </li>
                      ...
                      <Link>
                        ...
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "10%" }}>
                                <span className="fa fa-circle-o red_color"></span>
                              </td>
                              <td style={{ width: "80%" }}>
                      ...
                      <Link>
                        <li
                          className="prog-list-course-outline"
                          onClick={this.getTech}
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "10%" }}>
                                <span className="fa fa-circle-o green_color"></span>
                              </td>
                              <td style={{ width: "80%" }}>
                                <span style={{ width: "auto" }}>
                      ...
                      <Link>
                        ...
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "10%" }}>
                                <span className="fa fa-circle-o blue_color"></span>
                              </td>
                              <td style={{ width: "80%" }}>
                                <span style={{ width: "auto" }}>
                      ...
                      <Link>
                        <li
                          className="prog-list-course-outline"
                          onClick={this.getHumanities}
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "10%" }}>
                                <span className="fa fa-circle-o orange_color"></span>
                              </td>
                              <td style={{ width: "80%" }}>
                                <span style={{ width: "auto" }}>
                      ...
                      <Link>
                        ...
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "10%" }}>
                                <span className="fa fa-circle-o brown_color"></span>
                              </td>
                              <td style={{ width: "80%" }}>
                                <span style={{ width: "auto" }}>
                      ...
                      <Link>
                        ...
                        >
                          <table style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ width: "10%" }}>
                                <span className="fa fa-circle-o skyblue_color"></span>
                              </td>
                              <td style={{ width: "80%" }}>
                                <span style={{ width: "auto" }}>
                                  School Of Law
