        ...
        <React.Fragment>
            {props.gallerylister.map((item) => (
                <div className="col-md-4 filter photo" key={item.id} style={{marginBottom: '2rem'}}>
                    <div className="each-item gallery_img" onClick={props.view_photo.bind(this, item.id)}>
                    ...
                    <div id={item.id} className="modal_gallery">
                        ...
                        <span className="close_gallery" onClick={props.close_bio.bind(this, item.id)}>&times;</span>
                        <br/><br/>
