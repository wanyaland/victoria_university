			...
			<div className="justify-content-center"  style={{display: 'flex'}}>
				...
				<div className="col-lg-9"   style={{padding: '0px', backgroundColor: '#FFF', borderTopLeftRadius: '0px'}}>
					<div className="search_results">
						...
						<p className="my-4" style={{fontSize: '22px'}}>1. Are all industries/Sectors covered by this Victoria University WIL Program?</p>
                        <p className="mb-4">
						...
						<p className="my-4" style={{fontSize: '22px'}}>2. Does the organization need to provide anything for the student? </p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
						...
						<p className="my-4" style={{fontSize: '22px'}}>3. How will this program help my organization/business?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
						...
						<p className="my-4" style={{fontSize: '22px'}}>4. When are students available for the VU WIL?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
						...
						<p className="my-4" style={{fontSize: '22px'}}>5. How much work will my staff have to do to support the student? </p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
						...
						<p className="my-4" style={{fontSize: '22px'}}>6. This program sounds great, how much will it cost?</p>
                        <p className="mb-4">
                            <ul style={{listStyle: 'none'}}>
