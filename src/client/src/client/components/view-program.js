...
class ViewProgram extends Component {
	...
	updateFees = () => {
		...
		var tuition = document.getElementById('tuition')
		var mainDisplay = document.getElementById('main-display')
		if(this.state.course_prog.level === 'Professional Development' || this.state.course_prog.level === 'Foundations'){
			mainDisplay.innerHTML = '<table class="table table-bordered" style="font-size: .8em"><thead><tr><th scope="col">ITEM</th><th scope="col">FEES</th></tr></thead><tbody><tr><th scope="row">Application Fee (UGX)</th><td>'+this.state.course_prog.application_fee_loc+'</td></tr><tr><th scope="row">Caution Fee (UGX)</th><td>'+this.state.course_prog.caution_fee_loc+'</td></tr><tr><th scope="row">Funcitional Fees (UGX)</th><td>'+this.state.course_prog.local_func_fee+'</td></tr><tr><th scope="row">Identity Card (UGX)</th><td>'+this.state.course_prog.identity_card_loc+'</td></tr><tr><th scope="row">Registration Fees (UGX)</th><td>'+this.state.course_prog.reg_fee_loc+'</td></tr><tr><th scope="row">Tuition Fees(UGX)</th><td>'+this.state.course_prog.local_price+'</td></tr><tr><th>Total (UGX)</th><td>'+this.state.first_semL+'</td></tr></tbody></table><br><table class="table table-bordered" style="font-size: .8em"><thead><tr><th scope="col">ITEM</th><th scope="col">FEES</th></tr></thead><tbody><tr><th scope="row">Application Fee (UGX)</th><td>'+this.state.course_prog.application_fee_int+'</td></tr><tr><th scope="row">Caution Fee (UGX)</th><td>'+this.state.course_prog.caution_fee_int+'</td></tr><tr><th scope="row">Funcitional Fees (UGX)</th><td>'+this.state.course_prog.int_func_fee+'</td></tr><tr><th scope="row">Identity Card (UGX)</th><td>'+this.state.course_prog.identity_card_int+'</td></tr><tr><th scope="row">Registration Fees (UGX)</th><td>'+this.state.course_prog.reg_fee_int+'</td></tr><tr><th scope="row">Tuition Fees(UGX)</th><td>'+this.state.course_prog.int_price+'</td></tr><tr><th>Total (UGX)</th><td>'+this.state.first_sem_sem+'</td></tr></tbody></table>'
		} else if (this.state.course_prog.level === 'Diploma' || this.state.course_prog.level === 'Postgraduate'){
			...
			mainDisplay.innerHTML = '<table class="table table-bordered" style="font-size: .8em"><thead><tr><th scope="col">FEES (International Students)</th><th scope="col" colspan="2">YEAR 1</th><th scope="col" colspan="2">YEAR 2</th><th scope="col" colspan="2">YEAR 3</th></tr></thead><tbody><tr><td></td><td><b>SEM 1</b></td><td><b>SEM 2</b></td><td><b>SEM 1</b></td><td><b>SEM 2</b></td><td><b>SEM 1</b></td><td><b>SEM 2</b></td></tr><tr><th scope="row">Application Fee (USD)</th><td>'+this.state.course_prog.application_fee_int+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">Caution Fee (USD)</th><td>'+this.state.course_prog.caution_fee_int+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">Funcitional Fees (USD)</th><td>'+this.state.course_prog.int_func_fee+'</td><td></td><td>'+this.state.course_prog.int_func_fee+'</td><td></td><td>'+this.state.course_prog.int_func_fee+'</td><td></td></tr><tr><th scope="row">Identity Card (USD)</th><td>'+this.state.course_prog.identity_card_int+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">Registration Fees (USD)</th><td>'+this.state.course_prog.reg_fee_int+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">Tuition Fees(USD)</th><td>'+this.state.course_prog.int_price+'</td><td>'+this.state.course_prog.int_price+'</td><td>'+this.state.course_prog.int_price+'</td><td>'+this.state.course_prog.int_price+'</td><td>'+this.state.course_prog.int_price+'</td><td>'+this.state.course_prog.int_price+'</td></tr><tr><th>Total (USD)</th><td>'+this.state.first_sem_sem+'</td><td>'+this.state.second_sem+'</td><td>'+this.state.first_sem+'</td><td>'+this.state.second_sem+'</td><td>'+this.state.first_sem+'</td><td>'+this.state.second_sem+'</td></tr></tbody></table><br/><table class="table table-bordered" style="font-size: .8em"><thead><tr><th scope="col">FEES (Local Students)</th><th scope="col" colspan="2">YEAR 1</th><th scope="col" colspan="2">YEAR 2</th><th scope="col" colspan="2">YEAR 3</th></tr></thead><tbody><tr><td></td><td><b>SEM 1</b></td><td><b>SEM 2</b></td><td><b>SEM 1</b></td><td><b>SEM 2</b></td><td><b>SEM 1</b></td><td><b>SEM 2</b></td></tr><tr><th scope="row">APPLICATION FEE (UGX)</th><td>'+this.state.course_prog.application_fee_loc+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">CAUTION FEE (UGX)</th><td>'+this.state.course_prog.caution_fee_loc+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">FUNCTIONAL FEES (UGX)</th><td>'+this.state.course_prog.local_func_fee+'</td><td></td><td>'+this.state.course_prog.local_func_fee+'</td><td></td><td>'+this.state.course_prog.local_func_fee+'</td><td></td></tr><tr><th scope="row">IDENTITY CARD (UGX)</th><td>'+this.state.course_prog.identity_card_loc+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">REGISTRATION FEES (UGX)</th><td>'+this.state.course_prog.reg_fee_loc+'</td><td></td><td></td><td></td><td></td><td></td></tr><tr><th scope="row">TUITION FEES (UGX)</th><td>'+this.state.course_prog.local_price+'</td><td>'+this.state.course_prog.local_price+'</td><td>'+this.state.course_prog.local_price+'</td><td>'+this.state.course_prog.local_price+'</td><td>'+this.state.course_prog.local_price+'</td><td>'+this.state.course_prog.local_price+'</td></tr><tr><th>Total (UGX)</th><td>'+this.state.first_sem_semL+'</td><td>'+this.state.second_semL+'</td><td>'+this.state.first_semL+'</td><td>'+this.state.second_semL+'</td><td>'+this.state.first_semL+'</td><td>'+this.state.second_semL+'</td></tr></tbody></table>';
		}
		overview.classList.remove('activeSummaryBlue')
		duration.classList.remove('activeSummaryBlue')
		admission.classList.remove('activeSummaryBlue')
