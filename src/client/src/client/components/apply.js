            ...
            <div className="row grids-innf my-lg-5">
				<div className="features-1-info col-lg-6 col-md-6">
					...
					<div className="features-1-info-info text-center">
                        ...
                        <br/>
                        <button className="btn_link">Apply Now</button>
					</div>
				</div>
				<div className="features-1-info col-lg-6 col-md-6">
					<div className="features-1-info-icon text-center">
                              ...
                              <div className="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
                                  ...
                                  <div className="col-lg-12 welcome-image">
                                      <div className="" style={{width: '100%', backgroundColor: '#fff'}}>
                                        ...
                                        <p className="my-4">&emsp;<span>2.</span> &nbsp;Log in to myAU. You will need your student ID number.</p>
                                        <p>&emsp;&emsp;<span className="fa fa-angle-right"></span>&emsp;If this is your first time logging into myAU, your password will be your birthday (YYYYMMDD).</p>
							...
							<div className="contenter" style={{backgroundColor: '#FFF', borderBottom: '#CCC 1px solid'}}>
								...
								<div className="col-lg-12 welcome-image">
									<div className="" style={{width: '100%', backgroundColor: '#fff'}}>
                                        ...
                                        <p>
                                            <Link className="logo-2" to="/apply" style={{color: '#0077b5'}}  onMouseOver={this.change_icon.bind(this, "iconner15", "iconner16")} onMouseOut={this.change_icon2.bind(this, "iconner15", "iconner16")}>
