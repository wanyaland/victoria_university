                ...
                <div className="col-lg-3 with_shadow side_control" id="mob_bar_control">
                    <div className="sidenavd">
                        <ul className="w3-ul w3-card-4" style={{boxShadow: 'none'}}>
                            ...
                            <li className={this.state.url === "publication-res"? "prog-list prog-list-active quat-line" : "prog-list"} style={{padding: '6px 22px'}}><Link to='/publication-res' style={{fontSize: '16px'}}>Publications<span onClick="this.parentElement.style.display='none'" className="w3-button w3-transparent w3-display-right"></span></Link></li>
